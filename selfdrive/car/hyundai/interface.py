...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    ret.longitudinalTuning.kpV = [1.2, 0.9, 0.85, 0.75, 0.65, 0.45]
    ret.longitudinalTuning.kiBP = [0., 15. * CV.KPH_TO_MS, 30. * CV.KPH_TO_MS, 60. * CV.KPH_TO_MS, 80. * CV.KPH_TO_MS, 110. * CV.KPH_TO_MS]
    ret.longitudinalTuning.kiV = [0.015, 0.023, 0.022, 0.022, 0.017, 0.016]
    ...
    ret.longitudinalTuning.kfV = [1., 1., 1., 1., 0.85, 0.75]
